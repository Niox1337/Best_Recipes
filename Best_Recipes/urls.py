...
urlpatterns = [
    ...
    path('set_favourited_status', views.set_favourited_status, name="set_favourited_status"),
    path('get_favourited_status', views.get_favourited_status, name="get_favourited_status"),
    ...
    path('users/delete_profile',
        views.delete_profile, name='delete_profile'),
    path('users/handle_delete_profile',
        views.handle_delete_profile, name='handle_delete_profile'),
